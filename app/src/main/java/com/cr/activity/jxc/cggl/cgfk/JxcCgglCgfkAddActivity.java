...
public class JxcCgglCgfkAddActivity extends BaseActivity implements OnClickListener {
    ...
    private EditText                  bzxxEditText, gysEditText, jhdzEditText, djrqEditText,
            jbrEditText, rkckEditText, fkjeEditText, fklxEditText, jsfsEditText, zjzhEditText,
            dqyfEditText, dqyf2EditText, cyfjeEditText, sfjeEditText;
    ...
    private void initActivity() {
        ...
        // xzxsddLinearLayout=(LinearLayout)
        // findViewById(R.id.xzxsdd_linearlayout);
...
//            } else 
        ...
        try {
            ...
            for (Map<String, Object> map : list) {
                ...
                jsonObject2.put("amount ", map.get("bcjs").toString());
