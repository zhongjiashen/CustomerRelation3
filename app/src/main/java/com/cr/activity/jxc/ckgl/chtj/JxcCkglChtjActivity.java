...
import com.cr.adapter.jxc.ckgl.chtj.JxcCkglChtjAdapter;
 ...
 * 
 */
public class JxcCkglChtjActivity extends BaseActivity implements OnClickListener {
    private JxcCkglChtjAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_ckgl_chtj);
        addFHMethod();
        initActivity();
        initListView();
    ...
    private void initListView() {
        ...
        adapter = new JxcCkglChtjAdapter(list, this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(mContext, JxcCkglChtjDetailActivity.class);
                intent.putExtra("billid", list.get(arg2-1).get("billid").toString());
                if(JxcCkglChtjActivity.this.getIntent().hasExtra("select")){//如果是添加订单时候关联的操作
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(mContext, JxcCkglChtjSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.setClass(mContext, JxcCkglChtjAddActivity.class);
                startActivityForResult(intent, 1);
                break;
        }
    }
