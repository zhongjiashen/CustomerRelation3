...
public class JxcCkglChtjActivity extends BaseActivity implements OnClickListener {
    ...
    private void initListView() {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(context, JxcCkglChtjDetailActivity.class);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(context, JxcCkglChtjSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.setClass(context, JxcCkglChtjAddActivity.class);
                startActivityForResult(intent, 1);
                break;
        }
    }
