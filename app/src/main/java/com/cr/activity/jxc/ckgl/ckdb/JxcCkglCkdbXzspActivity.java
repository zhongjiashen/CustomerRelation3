...
import com.cr.adapter.jxc.ckgl.ckdb.JxcCkglCkdbXzspAdapter;
 ...
 * 
 */
public class JxcCkglCkdbXzspActivity extends BaseActivity implements
		OnClickListener {
	private JxcCkglCkdbXzspAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jxc_ckgl_ckdb_xzsp);
		addFHMethod();
		initActivity();
		initListView();
	...
	private void initListView() {
		...
		adapter = new JxcCkglCkdbXzspAdapter(list, this,storeid);
	...
	public void executeSuccess() {
		if (returnJson.equals("")) {
			...
			switch (returnSuccessType){
				case 0:ArrayList<Map<String, Object>> myList = (ArrayList<Map<String, Object>>) PaseJson
