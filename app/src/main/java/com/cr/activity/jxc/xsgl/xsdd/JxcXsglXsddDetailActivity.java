 ...
 *
 */
public class JxcXsglXsddDetailActivity extends BaseActivity implements OnClickListener {
    ...
    jhdzEditText, hjjeEditText, djrqEditText, jbrEditText,ysjeEditText;
    private CustomListView            listview;
    private List<Map<String, Object>> list;
    private LinearLayout              xzspLinearLayout;
    BaseAdapter                       adapter;
    private String                    gysId, lxrId, jbrId;
...
//            jhdzEditText.setText(object.get("billto").toString());
            ...
            adapter = new JxcXsglXsddDetailAdapter(list, this);
