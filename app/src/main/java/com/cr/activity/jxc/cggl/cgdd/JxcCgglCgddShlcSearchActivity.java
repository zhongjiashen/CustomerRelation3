...
/**
 * 进销存-采购管理-采购订单-审核流程-查询
 * @author Administrator
 *
 */
public class JxcCgglCgddShlcSearchActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_cggl_cgdd_shlc_search);
        addFHMethod();
        initActivity();
    }
