 ...
 * 
 */
public class JxcCkglZzcxXzspActivity extends BaseActivity implements
		OnClickListener {
	...
	private void searchDate() {
		...
		findServiceData2(0, ServerURL.SELECTGOODSZZCX, parmMap, false);
	}
