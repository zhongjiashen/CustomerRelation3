...
public class JxcCkglKcpdDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private void initActivity() {
        ...
        listview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                intent.setClass(activity, JxcCkglKcpdXzspDetail2Activity.class);
        ...
        adapter = new JxcCkglKcpdDetailAdapter(list, this);
    ...
    public void executeSuccess() {
        if (returnSuccessType == 0) {
            ...
            pdckId = object.get("storeid").toString();
...
//        }
        ...
        try {
            ...
            for (Map<String, Object> map : list) {
                ...
                jsonObject2.put("unitqty", map.get("spsl") == null ? map.get("unitqty").toString() : map.get("spsl").toString());
                ...
                for (int i = 0; i < cpList.size(); i++) {
                    ...
                    if (map.get("isDetail").equals("0")) {
                        if (map.get("ischecked").equals("1")) {
                            ...
                            map.put("spsl", map2.get("spsl"));
                            map.put("yksl", map2.get("yksl").toString());
                            list.add(map);
                        }
                    }
                }
