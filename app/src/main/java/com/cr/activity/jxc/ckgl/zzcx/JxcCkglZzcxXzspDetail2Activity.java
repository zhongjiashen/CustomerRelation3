...
/**
 * 进销存-仓库管理-组装拆卸-选择商品-选择的商品的详细信息（选择部件信息）
 * 
 * @author Administrator
 * 
 */
public class JxcCkglZzcxXzspDetail2Activity extends BaseActivity implements OnClickListener {
    TextView            mcTextView;
    TextView            bhTextView;
    TextView            ggTextView;
    TextView            xhTextView;
...
//            dwEditText.setText(object.get("unitname").toString());
            ...
            if (object.get("dj") != null) {
                ...
                dj = Double.parseDouble(object.get("anamount").toString());
