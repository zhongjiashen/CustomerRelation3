...
import com.cr.adapter.jxc.cggl.cgfk.JxcCgglCgfkAdapter;
 ...
 * 
 */
public class JxcCgglCgfkActivity extends BaseActivity implements OnClickListener {
    private JxcCgglCgfkAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_cggl_cgfk);
        addFHMethod();
        initActivity();
        initListView();
    ...
    private void initListView() {
        ...
        adapter = new JxcCgglCgfkAdapter(list, this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(mContext, KtJxcCgglCgfkDetailActivity.class);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(mContext, JxcCgglCgfkSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.setClass(mContext, KtJxcCgglCgfkAddActivity.class);
                startActivityForResult(intent, 1);
                break;
        }
    }
