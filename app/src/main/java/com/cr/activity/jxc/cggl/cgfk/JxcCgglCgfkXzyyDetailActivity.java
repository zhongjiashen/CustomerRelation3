 ...
 * 
 */
public class JxcCgglCgfkXzyyDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private void initActivity() {
        ...
        if (this.getIntent().hasExtra("object")) {
            ...
            bcjsEditText.setText(FigureTools.sswrFigure((object.get("amount")==null?object.get("bcjs").toString():object.get("amount").toString())));
        }
    }
