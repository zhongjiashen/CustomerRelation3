...
import com.cr.adapter.jxc.cggl.cgth.JxcCgglCgthAdapter;
import com.cr.adapter.jxc.xsgl.xsth.JxcXsglXsthAdapter;
 ...
 * 
 */
public class JxcXsglXsthActivity extends BaseActivity implements OnClickListener {
    private JxcXsglXsthAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_xsgl_xsth);
        addFHMethod();
        initActivity();
        initListView();
    ...
    private void initListView() {
        ...
        adapter = new JxcXsglXsthAdapter(list, this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(mContext, JxcXsglXsthDetailActivity.class);
                intent.putExtra("billid", list.get(arg2-1).get("billid").toString());
                if(JxcXsglXsthActivity.this.getIntent().hasExtra("select")){//如果是添加订单时候关联的操作
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(mContext, JxcXsglXsthSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.setClass(mContext, JxcXsglXsthAddActivity.class);
                startActivityForResult(intent, 1);
                break;
        }
    }
