 ...
 *
 */
public class JxcCgglCgddSearchActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_cggl_cgdd_search);
        addFHMethod();
        initActivity();
    }
    ...
    private void initActivity() {
        ...
        }if(this.getIntent().getExtras().getString("sh").equals("1")){
            shId="1";
            shEditText.setText("已审核");
        }if(this.getIntent().getExtras().getString("sh").equals("2")){
            shId="2";
            shEditText.setText("审核中");
        }if (this.getIntent().getExtras().getString("sh").equals("3")){
            shId="3";
