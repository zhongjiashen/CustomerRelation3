...
import com.cr.adapter.jxc.ckgl.kcbd.JxcCkglKcbdAdapter;
...
public class JxcCkglKcbdActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jxc_ckgl_kcbd);
        addFHMethod();
        initActivity();
        initListView();
    ...
    private void initListView() {
        ...
        adapter = new JxcCkglKcbdAdapter(list, this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                Intent intent = new Intent(mContext, JxcCkglKcbdDetailActivity.class);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sx:
                intent.setClass(mContext, JxcCkglKcbdSearchActivity.class);
            ...
            case R.id.xz:
                ...
                intent.setClass(mContext, JxcCkglKcbdAddActivity.class);
                startActivityForResult(intent, 1);
                break;
        }
    }
