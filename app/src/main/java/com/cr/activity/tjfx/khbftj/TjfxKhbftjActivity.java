package com.cr.activity.tjfx.khbftj;
 ...
 * 
 */
public class TjfxKhbftjActivity extends BaseActivity implements OnClickListener {
	private TjfxKhbftjAdapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxKhbftjAdapter(list, this);
...
//				}
	...
	private void searchDate() {
		...
		findServiceData2(0, ServerURL.CLIENTVISITRPT, parmMap, false);
	}
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.sx:
			intent.setClass(mContext, TjfxKhbftjSearchActivity.class);
