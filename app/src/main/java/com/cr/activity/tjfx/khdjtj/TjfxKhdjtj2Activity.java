package com.cr.activity.tjfx.khdjtj;
...
import com.cr.activity.tjfx.khbftj.TjfxKhbftjAdapter;
 ...
 * 
 */
public class TjfxKhdjtj2Activity extends BaseActivity implements OnClickListener {
	private TjfxKhdjtj2Adapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxKhdjtj2Adapter(list, this);
...
//		parmMap.put("zrrq", zr);
		...
		parmMap.put("typeid", this.getIntent().getExtras().getString("typeid"));
		parmMap.put("curpage", currentPage);
		parmMap.put("pagesize", pageSize);
		findServiceData2(0, ServerURL.CLIENTTYPEDETAILRPT, parmMap, false);
	}
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.sx:
			intent.setClass(mContext, TjfxKhdjtjSearchActivity.class);
