...
public class TjfxXsskhzb2Adapter extends BaseAdapter {

    List<Map<String, Object>> list;
    private Activity          activity;
    private int               selectIndex;

    public TjfxXsskhzb2Adapter(List<Map<String, Object>> list, Activity activity) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.nameTextView.setText(objMap.get("name").toString());
        viewHolder.valueTextView.setText(objMap.get("value").toString());
        return convertView;
    }
