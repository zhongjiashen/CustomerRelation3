 ...
 *
 */
public class TjfxJyzkSearchActivity extends BaseActivity implements OnClickListener {
...
//    String    shId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tjfx_jyzk_search);
        addFHMethod();
        initActivity();
    }
...
//        khEditText = (EditText) findViewById(R.id.kh_edittext);
        ...
        qrEditText .setText(sdf.format(new Date()) + "01");
        zrEditText .setText(sdf.format(new Date())
