 ...
 * 
 */
public class TjfxKhdjtjSearchActivity extends BaseActivity implements
		OnClickListener {
	EditText ywyEditText;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tjfx_khdjtj_search);
		addFHMethod();
		initActivity();
	}
...
//		zrEditText.setVisibility(View.GONE);
