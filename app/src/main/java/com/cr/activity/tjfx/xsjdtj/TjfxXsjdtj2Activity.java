 ...
 * 
 */
public class TjfxXsjdtj2Activity extends BaseActivity implements OnClickListener {
	private TjfxXsjdtj2Adapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxXsjdtj2Adapter(list, this);
