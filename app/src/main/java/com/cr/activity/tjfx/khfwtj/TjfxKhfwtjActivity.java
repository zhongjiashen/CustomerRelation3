package com.cr.activity.tjfx.khfwtj;
 ...
 * 
 */
public class TjfxKhfwtjActivity extends BaseActivity implements OnClickListener {
	private TjfxKhfwtjAdapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxKhfwtjAdapter(list, this);
...
//				}
	...
	private void searchDate() {
		...
		findServiceData2(0, ServerURL.CLIENTSERVICERPT, parmMap, false);
	}
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.sx:
			intent.setClass(mContext, TjfxKhfwtjSearchActivity.class);
