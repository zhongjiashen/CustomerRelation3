 ...
 * 
 */
public class TjfxXkhtjActivity extends BaseActivity implements OnClickListener {
	private TjfxXkhtjAdapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxXkhtjAdapter(list, this);
...
//				}
	...
	private void searchDate() {
		...
		findServiceData2(0, ServerURL.NEWADDCLIENTRPT, parmMap, false);
	}
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.sx:
			intent.setClass(mContext, TjfxXkhtjSearchActivity.class);
