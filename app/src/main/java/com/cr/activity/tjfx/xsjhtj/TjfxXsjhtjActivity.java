 ...
 * 
 */
public class TjfxXsjhtjActivity extends BaseActivity implements OnClickListener {
	private TjfxXsjhtjAdapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxXsjhtjAdapter(list, this);
...
//				}
	...
	private void searchDate() {
		...
		findServiceData2(0, ServerURL.SALECHANCERPT, parmMap, false);
	}
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.sx:
			intent.setClass(mContext, TjfxXsjhtjSearchActivity.class);
