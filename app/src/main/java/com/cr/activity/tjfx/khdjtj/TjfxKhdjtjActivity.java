 ...
 * 
 */
public class TjfxKhdjtjActivity extends BaseActivity implements OnClickListener {
	private TjfxKhdjtjAdapter adapter;
...
//	String lxid="0",lxname="全部",mc="";
	...
	private void initListView() {
		...
		adapter = new TjfxKhdjtjAdapter(list, this);
...
//				}
				...
				intent.setClass(activity, TjfxKhdjtj2Activity.class);
				intent.putExtra("typeid", list.get(arg2-1).get("typeid").toString());
...
//		parmMap.put("zzrq", zr);
		...
		findServiceData2(0, ServerURL.CLIENTTYPERPT, parmMap, false);
	}
