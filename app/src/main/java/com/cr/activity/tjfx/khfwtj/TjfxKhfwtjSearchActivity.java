...
import com.cr.activity.common.CommonXzywy2Activity;
 ...
 * 
 */
public class TjfxKhfwtjSearchActivity extends BaseActivity implements
		OnClickListener {
	...
	public void onClick(View arg0) {
		...
		case R.id.ywy_edittext:
			intent.setClass(activity, CommonXzywy2Activity.class);
