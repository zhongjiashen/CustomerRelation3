package com.cr.activity.tjfx.fzb
 ...
 * 资产负债表
 */
class KtTjfxFzbActivity : BaseActivity<BaseP>(), PullToRefreshLayout.OnRefreshListener {
    ...
    override fun init() {
        titlebar.setTitleText(mActivity, "资产负债表")
    ...
    fun http(i: Int) {
        ...
        mParmMap["zzrq"] = mZzrq
        mParmMap["curpage"] = page_number.toString()
        presenter.post(i, "cwbalance", mParmMap)
    }
