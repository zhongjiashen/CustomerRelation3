 ...
 *
 */
public class GzptDwzlBfBflrDetailActivity extends BaseActivity implements OnClickListener {
...
//    private String   lxrId, xsjhId, dqjdId, bffsId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gzpt_dwzl_bf_bflr_detail);
        addFHMethod();
        initActivity();
    }
...
//        yyCheckBox = (CheckBox) findViewById(R.id.yy_checkbox);
        ...
        bffsEditText.setText(object.get("bflxmc").toString());
        yysjEditText.setText(object.get("nextdate").toString());
        xsjhEditText.setText(object.get("title").toString());
        
        bfnrEditText.setFocusable(false);
    }
