...
public class GzptYybfActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gzpt_yybf);
		addFHMethod();
		initActivity();
		initListView();
//		searchDate();
	...
	private void searchDate(){
		...
		findServiceData(0,ServerURL.JHRWYYBF,parmMap);
	}
