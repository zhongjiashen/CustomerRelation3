...
public class XmAdapter extends BaseAdapter {
	...
	public XmAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_xm_item, null);// 这个过程相当耗时间
