 ...
 */
public class XjyhSkdDetailActivity extends BaseActivity implements
        OnClickListener {
    @BindView(R.id.et_bm)
    EditText etBm;
    ...
    private EditText wldwEditText, fklxEditText, jsfsEditText, zjzhEditText,
            dqyfEditText, dqyf2EditText, fkjeEditText, djrqEditText, bzxxEditText,
            jbrEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xjyh_skd_detail);
...
//			adapter.notifyDataSetChanged();
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.sh_button:
                intent.putExtra("tb", "tb_charge_skd");
