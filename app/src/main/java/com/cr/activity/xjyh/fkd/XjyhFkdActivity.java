 ...
 * 
 */
public class XjyhFkdActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_xjyh_fkd);
		addFHMethod();
		initActivity();
		initListView();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.putExtra("billid", list.get(arg2 - 1).get("billid")
						.toString());
				if (XjyhFkdActivity.this.getIntent().hasExtra("select")) {// 如果是添加订单时候关联的操作
