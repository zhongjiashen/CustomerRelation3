 ...
 */
public class XjyhFkdAddActivity extends BaseActivity implements
        OnClickListener {
    @BindView(R.id.et_bm)
    EditText etBm;
    private ImageButton saveImageButton;
    private EditText wldwEditText, fklxEditText, jsfsEditText, zjzhEditText,
            dqyfEditText, dqyf2EditText, fkjeEditText, djrqEditText, jbrEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xjyh_fkd_add);
