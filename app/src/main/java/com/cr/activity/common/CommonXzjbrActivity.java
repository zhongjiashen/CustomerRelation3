 ...
 */
public class CommonXzjbrActivity extends BaseActivity implements OnClickListener {
	private CommonXzjbrAdapter adapter;
	...
	private void initListView(){
		adapter=new CommonXzjbrAdapter(list,this);
...
//        parmMap.put("opid", ShareUserInfo.getUserId(context));
        ...
        findServiceData2(0,ServerURL.EMPLOYLIST,parmMap,true);
	}
