...
import com.cr.adapter.common.CommonXzspflAdapter;
 ...
 */
public class CommonXzsplbActivity extends BaseActivity implements OnClickListener {
	private CommonXzspflAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_common_xzsplb);
		addFHMethod();
		initActivity();
		initListView();
		list.clear();
	...
	private void initListView(){
		adapter=new CommonXzspflAdapter(list,this);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
			    ...
			    intent.putExtra("id",map.get("lcode").toString());
...
//        parmMap.put("pagesize",pageSize);
        findServiceData2(0,ServerURL.GOODSTYPE,parmMap,true);
	}
