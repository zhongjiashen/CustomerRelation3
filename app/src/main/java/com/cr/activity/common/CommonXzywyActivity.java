...
import com.cr.adapter.common.CommonXzjbrAdapter;
import com.cr.adapter.common.CommonXzywyAdapter;
 ...
 */
public class CommonXzywyActivity extends BaseActivity implements OnClickListener {
	private CommonXzywyAdapter adapter;
	...
	private void initListView(){
		adapter=new CommonXzywyAdapter(list,this);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
			    ...
			    intent.putExtra("id",map.get("opid").toString());
			    intent.putExtra("name", map.get("opname").toString());
...
//        parmMap.put("empname",searchEditText.getText().toString());
        ...
        findServiceData2(0,ServerURL.SELECTOPER_1,parmMap,true);
	}
