 ...
 */
public class CommonXzgysActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_common_xzgys);
		addFHMethod();
		initActivity();
		initListView();
		list.clear();
...
//        parmMap.put("clientid",clientid);
        ...
        findServiceData2(0,ServerURL.CLIENTLIST2,parmMap,true);
	}
