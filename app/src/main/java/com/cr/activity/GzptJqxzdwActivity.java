 ...
 *
 */
public class GzptJqxzdwActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gzpt_jqxzdw);
		addFHMethod();
		initActivity();
		initListView();
//		searchDate();
...
//		parmMap.put("filter","");
		...
		findServiceData(0,ServerURL.JHRWXZLD,parmMap);
	}
