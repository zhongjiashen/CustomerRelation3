 ...
 * 
 * @author caiyanfei
 * @version $Id: QQExpandableListView.java, v 0.1 2014年9月16日 下午4:20:14 lenovo Exp $
 */
public class QQExpandableListView extends ExpandableListView implements OnScrollListener,
                                                            OnGroupClickListener {
    public QQExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        registerListener();
    }

    public QQExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        registerListener();
    }

    public QQExpandableListView(Context context) {
        super(context);
        registerListener();
    }
