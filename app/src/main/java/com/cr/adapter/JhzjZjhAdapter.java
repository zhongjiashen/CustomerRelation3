 ...
 *
 */
public class JhzjZjhAdapter extends BaseAdapter {

	List<JHRW> list;
	private Context mContext;
	private Activity activity;

	public JhzjZjhAdapter(List<JHRW> list, Context context,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_jhzj_zjh_item, null);// 这个过程相当耗时间
