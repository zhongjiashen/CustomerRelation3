package com.cr.adapter.tjfx.jyzk;
...
public class TjfxJyzkAdapter extends BaseAdapter {
	...
	public TjfxJyzkAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_tjfx_jyzk_item, null);// 这个过程相当耗时间
