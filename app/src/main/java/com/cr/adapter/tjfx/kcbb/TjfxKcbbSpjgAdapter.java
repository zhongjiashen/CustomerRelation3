...
public class TjfxKcbbSpjgAdapter extends BaseAdapter {
	...
	public TjfxKcbbSpjgAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_tjfx_kcbb_spjg_item, null);// 这个过程相当耗时间
...
//			viewHolder.xhTextView = (TextView) convertVi4ew.findViewById(R.id.xh_textview);
