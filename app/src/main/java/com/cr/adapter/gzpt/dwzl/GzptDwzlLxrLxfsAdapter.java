...
public class GzptDwzlLxrLxfsAdapter extends BaseAdapter {

	List<Map<String, Object>> list;
	private BaseActivity activity;

	public GzptDwzlLxrLxfsAdapter(List<Map<String, Object>> list,BaseActivity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_gzpt_dwzl_lxr_lxfs_item, null);// 这个过程相当耗时间
