...
public class JhzjRjhAdapter extends BaseAdapter {
	...
	public JhzjRjhAdapter(List<JHRW> list, Context context,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_jhzj_rjh_item, null);// 这个过程相当耗时间
