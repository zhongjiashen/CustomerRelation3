package com.cr.adapter.xjyh.yhcq;
...
public class XjyhYhcqAdapter extends BaseAdapter {
	...
	public XjyhYhcqAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_xjyh_fyzc_item, null);// 这个过程相当耗时间
			...
			viewHolder.zczhTextView = (TextView) convertView.findViewById(R.id.zczh_textview);
			viewHolder.zrzhTextView = (TextView) convertView.findViewById(R.id.zrzh_textview);
	...
	static class ViewHolder {
		...
		TextView zczhTextView;
		TextView zrzhTextView;
