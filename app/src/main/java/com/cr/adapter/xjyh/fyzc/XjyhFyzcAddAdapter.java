package com.cr.adapter.xjyh.fyzc;
...
public class XjyhFyzcAddAdapter extends BaseAdapter {

	List<Map<String, Object>> list;
	private Activity activity;

	public XjyhFyzcAddAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.fyjeTextView.setText("￥"+objMap.get("amount").toString());
		return convertView;
	}
