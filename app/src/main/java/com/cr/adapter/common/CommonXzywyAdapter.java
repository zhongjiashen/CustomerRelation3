...
public class CommonXzywyAdapter extends BaseAdapter {
	List<Map<String, Object>> list;
	private Activity activity;
	public CommonXzywyAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.nameTextView.setText(sb.get("opname").toString());
