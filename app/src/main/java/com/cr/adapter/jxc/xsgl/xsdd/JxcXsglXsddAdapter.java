package com.cr.adapter.jxc.xsgl.xsdd;
...
public class JxcXsglXsddAdapter extends BaseAdapter {

	List<Map<String, Object>> list;
	private Activity activity;
	private int selectIndex;

	public JxcXsglXsddAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_jxc_xsgl_xsdd_item, null);// 这个过程相当耗时间
