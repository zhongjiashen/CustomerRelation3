...
public class JxcCkglZzcxAdapter extends BaseAdapter {

	List<Map<String, Object>> list;
	private Activity activity;
	private int selectIndex;

	public JxcCkglZzcxAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(activity).inflate(R.layout.activity_jxc_ckgl_zzcx_item, null);// 这个过程相当耗时间
			...
			viewHolder.ckTextView = (TextView) convertView.findViewById(R.id.ck_textview);
			viewHolder.msTextView = (TextView) convertView.findViewById(R.id.ms_textview);
		...
		viewHolder.ckTextView.setText(objMap.get("storename").toString());
		viewHolder.msTextView.setText(objMap.get("goodsname").toString()+" "+
