...
public class JxcCgglCgddDetailAdapter extends BaseAdapter {

    List<Map<String, Object>> list;
    private Activity          activity;

    public JxcCgglCgddDetailAdapter(List<Map<String, Object>> list, Activity activity) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.bhmcggTextView.setText((objMap.get("goodscode")==null?objMap.get("code").toString():objMap.get("goodscode").toString()) + " "
        ...
        viewHolder.djTextView.setText("￥" + (objMap.get("dj")==null?objMap.get("unitprice").toString():objMap.get("dj").toString()) + "*"
