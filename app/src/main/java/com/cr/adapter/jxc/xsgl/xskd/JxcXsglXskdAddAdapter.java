package com.cr.adapter.jxc.xsgl.xskd;
...
public class JxcXsglXskdAddAdapter extends BaseAdapter {

	List<Map<String, Object>> list;
	private Activity activity;

	public JxcXsglXskdAddAdapter(List<Map<String, Object>> list,
			Activity activity) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.bhmcggTextView = (TextView) convertView
					.findViewById(R.id.bhmcgg);
			viewHolder.djTextView = (TextView) convertView
		...
		viewHolder.bhmcggTextView
				.setText((objMap.get("goodscode") == null ? objMap.get("code")
						.toString() : objMap.get("goodscode").toString())
						+ " "
						+ (objMap.get("goodsname") == null ? objMap.get("name")
								.toString() : objMap.get("goodsname")
								.toString())
						+ " "
		...
		viewHolder.tvBz.setText((objMap.get("memo") == null ? "" : objMap.get("memo").toString()));
		return convertView;
	}
