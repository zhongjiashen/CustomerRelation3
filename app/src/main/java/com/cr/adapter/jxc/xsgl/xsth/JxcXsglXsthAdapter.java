package com.cr.adapter.jxc.xsgl.xsth;
...
public class JxcXsglXsthAdapter extends BaseAdapter {

	List<Map<String, Object>> list;
	private Activity activity;
	private int selectIndex;

	public JxcXsglXsthAdapter(List<Map<String, Object>> list,Activity activity) {
		this.list=list;
