 ...
 /* 选择文件集合信息处理 */
    ...
    public void returnData(int requestCode, Object data) {
        ...
        if (list != null && list.size() != 0) {
            ...
            tvMaintenanceResults.setText(mData.getWxjgname());//安装结果设置
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_registration_details://查看登记详情
                startActivityForResult(new Intent(DetectionDetailsActivity.this, InstallRegistrationDetailsActivity.class)
