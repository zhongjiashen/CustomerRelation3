...
/**
 * Created by 1363655717 on 2018-03-25.
 */

public class DetectionDetailsData {
    ...
    private double desqty;
    @SerializedName("begindate")
    private String begindate;
    @SerializedName("enddate")
    private String enddate;
    @SerializedName("factfault")
    private String factfault;
    ...
    public double getDesqty() {
        return desqty;
    }

    public void setDesqty(double desqty) {
        this.desqty = desqty;
    }
    ...
    public void setEnsureid(int ensureid) {
