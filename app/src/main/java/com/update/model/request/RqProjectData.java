...
public class RqProjectData {
    ...
    public String getXmlyname() {
        return xmlyname;
    }

    public void setXmlyname(String xmlyname) {
        this.xmlyname = xmlyname;
    }
